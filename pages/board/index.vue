                    ...
                    <v-icon
                      v-else-if="
                        rooms[0].taken_tickets_1st / rooms[0].stock_1st >=
                          0.5 && rooms[0].taken_tickets_1st < rooms[0].stock_1st
                      "
                      color="orange"
                    ...
                    <v-icon
                      v-else-if="
                        rooms[0].taken_tickets_2nd / rooms[0].stock_2nd >=
                          0.5 && rooms[0].taken_tickets_2nd < rooms[0].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[1].taken_tickets_1st / rooms[1].stock_1st >=
                          0.5 && rooms[1].taken_tickets_1st < rooms[1].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[1].taken_tickets_2nd / rooms[1].stock_2nd >=
                          0.5 && rooms[1].taken_tickets_2nd < rooms[1].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[8].taken_tickets_1st / rooms[8].stock_1st >=
                          0.5 && rooms[8].taken_tickets_1st < rooms[8].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[8].taken_tickets_2nd / rooms[8].stock_2nd >=
                          0.5 && rooms[8].taken_tickets_2nd < rooms[8].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[9].taken_tickets_1st / rooms[9].stock_1st >=
                          0.5 && rooms[9].taken_tickets_1st < rooms[9].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[9].taken_tickets_2nd / rooms[9].stock_2nd >=
                          0.5 && rooms[9].taken_tickets_2nd < rooms[9].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[2].taken_tickets_1st / rooms[2].stock_1st >=
                          0.5 && rooms[2].taken_tickets_1st < rooms[2].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[2].taken_tickets_2nd / rooms[2].stock_2nd >=
                          0.5 && rooms[2].taken_tickets_2nd < rooms[2].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[3].taken_tickets_1st / rooms[3].stock_1st >=
                          0.5 && rooms[3].taken_tickets_1st < rooms[3].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[3].taken_tickets_2nd / rooms[3].stock_2nd >=
                          0.5 && rooms[3].taken_tickets_2nd < rooms[3].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[4].taken_tickets_1st / rooms[4].stock_1st >=
                          0.5 && rooms[4].taken_tickets_1st < rooms[4].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[4].taken_tickets_2nd / rooms[4].stock_2nd >=
                          0.5 && rooms[4].taken_tickets_2nd < rooms[4].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[5].taken_tickets_1st / rooms[5].stock_1st >=
                          0.5 && rooms[5].taken_tickets_1st < rooms[5].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[5].taken_tickets_2nd / rooms[5].stock_2nd >=
                          0.5 && rooms[5].taken_tickets_2nd < rooms[5].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[6].taken_tickets_1st / rooms[6].stock_1st >=
                          0.5 && rooms[6].taken_tickets_1st < rooms[6].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[6].taken_tickets_2nd / rooms[6].stock_2nd >=
                          0.5 && rooms[6].taken_tickets_2nd < rooms[6].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[7].taken_tickets_1st / rooms[7].stock_1st >=
                          0.5 && rooms[7].taken_tickets_1st < rooms[7].stock_1st
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
                    ...
                    <v-icon
                      v-else-if="
                        rooms[7].taken_tickets_2nd / rooms[7].stock_2nd >=
                          0.5 && rooms[7].taken_tickets_2nd < rooms[7].stock_2nd
                      "
                      color="orange"
                      >mdi-triangle-outline</v-icon
                    >
